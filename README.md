...
需求：Python 3.10 以上與 [`uv`](https://docs.astral.sh/uv/)；完整 GUI 使用系統 Tk。Issue #9/#10 的 webview 工作區另需 `pywebview==5.4`、Ubuntu GTK/WebKit 套件與下列一次性 venv 設定：
...
# Issue #10 離線 capture/review workspace（明確 opt-in）
